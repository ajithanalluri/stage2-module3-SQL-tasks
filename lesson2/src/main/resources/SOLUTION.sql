...
values(1,'Jon','2000-10-10',1),(2,'Chri','2001-12-15',1),(3,'Car','2009-11-10',1),(4,'Olive','2008-10-10',2),(5,'Jame', '2000-09-10',2),(6,'Luca',,2),(7,'Henr',,2),(8,'Jaco','2006-10-22',3),(9,'Loga','2000-10-14',3),(10,'Alex','2010-05-10',4),(11, 'Alexa','2005-12-10',5);

INSERT INTO Subject(id, name,description,grade)
values(1, 'Art', 'Art subject', 1),(2, 'music', 'music subject', 1),(3, 'Geography', 'Geography subject', 2),(4, 'history', 'history subject', 2),(5, 'PE', 'PE subject', 3),(6, 'Math', 'maths subject', 3),(7, 'Science', 'Science subject', 4),(8, 'IT', 'IT subject',  4),(9, 'Compiler', 'Compiler', 5),(10, 'Systems', 'Systems', 5);
